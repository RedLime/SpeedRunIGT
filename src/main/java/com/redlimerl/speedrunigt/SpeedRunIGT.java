...
public class SpeedRunIGT implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        SpeedRunOptions.addOptionButton(screen ->
                new ButtonWidget(0, 0, 150, 20,
                        I18n.translate("speedrunigt.option.check_info"), (ButtonWidget button) -> MinecraftClient.getInstance().openScreen(new SpeedRunIGTInfoScreen(screen)))
        );
        ...
        SpeedRunOptions.addOptionButton(screen -> new ButtonWidget(0, 0, 150, 20, I18n.translate("speedrunigt.option.hide_timer_in_debugs") + " : " + (SpeedRunOptions.getOption(SpeedRunOptions.HIDE_TIMER_IN_DEBUGS) ? ScreenTexts.ON : ScreenTexts.OFF), (ButtonWidget button) -> {
            ...
            button.setMessage(I18n.translate("speedrunigt.option.hide_timer_in_debugs") + " : " + (SpeedRunOptions.getOption(SpeedRunOptions.HIDE_TIMER_IN_DEBUGS) ? ScreenTexts.ON : ScreenTexts.OFF));
        }));
        SpeedRunOptions.addOptionButton(screen ->
                new ButtonWidget(0, 0, 150, 20,
