...
public class SpeedRunIGT implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        SpeedRunOptions.addOptionButton(screen -> new ButtonWidget(905,0, 0, 150, 20, SpeedRunIGT.translate("speedrunigt.option.hide_timer_in_debugs", "Hide Timer in Debugs").getString() + " : " + (SpeedRunOptions.getOption(SpeedRunOptions.HIDE_TIMER_IN_DEBUGS) ? ScreenTexts.ON : ScreenTexts.OFF)));
