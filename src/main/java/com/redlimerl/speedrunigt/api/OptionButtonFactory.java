...
public interface OptionButtonFactory {
    class Builder {
        ...
        public Builder setButtonWidget(ButtonWidget buttonWidget) {
            ...
            if (((ButtonWidgetAccessor) buttonWidget).getWidth() != 150 || buttonWidgetAccessor.getHeight() != 20) throw new IllegalArgumentException("ButtonWidget should be width 150, height 20");
