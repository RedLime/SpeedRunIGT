...
public class OptionButtonsImpl implements SpeedRunIGTApi {
    ...
    public Collection<OptionButtonFactory> createOptionButtons() {
        ...
        factories.add(screen -> new OptionButtonFactory.Builder()
                .setButtonWidget(
                        new ButtonWidget(0, 0, 150, 20, new TranslatableText("speedrunigt.option.therun_gg.open_therun_gg").asFormattedString(),
        ...
        factories.add(screen -> new OptionButtonFactory.Builder()
                .setButtonWidget(
                        new ButtonWidget(0, 0, 150, 20, new TranslatableText("speedrunigt.option.therun_gg.edit_upload_key").asFormattedString(),
