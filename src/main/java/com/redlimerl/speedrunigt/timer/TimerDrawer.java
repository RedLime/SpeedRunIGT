...
public class TimerDrawer {
    ...
    public void draw() {
        ...
        FontManagerAccessor fontManagerAccessor = (FontManagerAccessor) ((MinecraftClientAccessor) client).getFontManager();
        if (getTimerFont() != MinecraftClient.DEFAULT_TEXT_RENDERER_ID && fontManagerAccessor.getTextRenderers().containsKey(getTimerFont())) {
            targetFont = fontManagerAccessor.getTextRenderers().get(getTimerFont());
