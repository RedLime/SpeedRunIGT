...
public class InGameTimerUtils {
    ...
    public static boolean isLoadableBlind(Dimension dimensionType, Vec3d netherPos, Vec3d overPos) {
        ...
        List<RunPortalPos> arrayList = dimensionType instanceof TheNetherDimension ? timer.lastNetherPortalPos : dimensionType instanceof OverworldDimension ? timer.lastOverWorldPortalPos : null;
    ...
    public static Difficulty getCurrentDifficulty() {
        ...
        return server.getWorld().getGlobalDifficulty();
    }
}
