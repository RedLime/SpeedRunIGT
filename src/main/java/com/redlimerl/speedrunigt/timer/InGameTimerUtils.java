...
public class InGameTimerUtils {
    ...
    public static boolean isLoadableBlind(DimensionType dimensionType, Vec3d netherPos, Vec3d overPos) {
        ...
        ArrayList<RunPortalPos> arrayList = dimensionType == DimensionType.NETHER ? timer.lastNetherPortalPos : dimensionType == DimensionType.OVERWORLD ? timer.lastOverWorldPortalPos : null;
