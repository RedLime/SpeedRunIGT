...
public class ObtainItemCategoryCondition extends CategoryCondition.Condition<List<ItemStack>> {
    ...
    public boolean checkConditionComplete(List<ItemStack> itemStacks) {
        ...
        for (ItemStack itemStack : itemStacks) {
            if (itemStack != null && Objects.equals(Objects.requireNonNull(Registry.ITEM.getId(itemStack.getItem())).toString(), itemID) && (itemDamage == null || itemStack.getDamage() == itemDamage)) {
                if (!nbtTag.isEmpty()) {
