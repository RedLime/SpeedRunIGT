...
private final String title = SpeedRunIGT.translate("speedrunigt.option.timer_position","Timer Display Options").asString();
    ...
    public void init() {
        ...
        this.normalButton =new ButtonWidget(5001,width / 2 - 89, height / 2 - 48, 58, 20, new TranslatableText("options.title").append("...").asString());
        buttons.add(normalButton);
        this.normalButton.active = false;

        this.igtButton = new ButtonWidget(5002,width / 2 - 29, height / 2 - 48, 58, 20, new LiteralText("IGT...").asString());
        buttons.add(igtButton);

        this.rtaButton =new ButtonWidget(5003,width / 2 + 31, height / 2 - 48, 58, 20, new LiteralText("RTA...").asString());
        this.buttons.add(rtaButton);


        buttons.add(new ButtonWidget(5005,width / 2 - 89, height / 2 + 62, 58, 20, SpeedRunIGT.translate("speedrunigt.option.hide","Hide").asString()));

        this.saveButton = new ButtonWidget(5006,width / 2 - 29, height / 2 + 62, 58, 20, SpeedRunIGT.translate("speedrunigt.option.save","Save").asString());
    ...
    protected void buttonClicked(ButtonWidget button) {
        if(button.id==5001){
                ...
                button.message=(SpeedRunIGT.translate("speedrunigt.option." + (!hide ? "hide" : "show"), (!hide ? "Hide" : "Show"))).asString();
        }
            ...
            if (client != null) client.openScreen(parent);
                ...
                changed = true;
                button.message=(SpeedRunIGT.translate("speedrunigt.option.timer_position.show_time_only","Disable Timer Labels").append(" : ").append(drawer.isSimplyTimer() ? ScreenTexts.ON : ScreenTexts.OFF)).asString();
        }
        else if(button.id==5008){
                drawer.setLocked(!drawer.isLocked());
                changed = true;
                button.message=(SpeedRunIGT.translate("speedrunigt.option.timer_position.lock_timer_position","Lock Timer Position").append(" : ").append(drawer.isLocked() ? ScreenTexts.ON : ScreenTexts.OFF)).asString();
        }
                ...
                changed = true;
                button.message=(SpeedRunIGT.translate("speedrunigt.option.timer_position.show_decimals","Timer Precision").append(" : ").append(new TranslatableText("speedrunigt.option.timer_position.show_decimals.context", drawer.getTimerDecimals().getNumber()))).asString();
        }
                ...
                changed = true;
                button.message=SpeedRunIGT.translate("speedrunigt.option.timer_position.igt.text_decorate", "IGT Text Style").append(" : ").append(SpeedRunIGT.translate("speedrunigt.option.timer_position.text_decorate." + drawer.getIGTDecoration().name().toLowerCase(Locale.ROOT),drawer.getRTADecoration().name().toLowerCase(Locale.ROOT))).asString();
        }
            ...
            changed = true;
            button.message = SpeedRunIGT.translate("speedrunigt.option.timer_position.rta,text_decorate", "RTA Text Style").append(" : ").append(SpeedRunIGT.translate("speedrunigt.option.timer_position.text_decorate." + drawer.getRTADecoration().name().toLowerCase(Locale.ROOT), drawer.getRTADecoration().name().toLowerCase(Locale.ROOT))).asString();
        }
            ...
            if (!igtButton.active || !rtaButton.active) {
                if (drawer.isLocked()) {
                    drawCenteredString( this.textRenderer,
                            SpeedRunIGT.translate("speedrunigt.option.timer_position.description.lock","§cA Timer position is locked!").asString(), this.width / 2, this.height / 2 - 80, 16777215);
                } else {
                    drawCenteredString( this.textRenderer,
                            SpeedRunIGT.translate("speedrunigt.option.timer_position.description","§eClick on a position to change the timer position.").asString(), this.width / 2, this.height / 2 - 80, 16777215);
                    drawCenteredString( this.textRenderer,
                            SpeedRunIGT.translate("speedrunigt.option.timer_position.description.move","You can finely adjust the position by pressing §eCtrl + arrow key.").asString(), this.width / 2, this.height / 2 - 69, 16777215);
                }
            }
    ...
    public void initNormal() {
        ButtonWidget b1= new ButtonWidget(5090,width / 2 - 80, height / 2 - 16, 160, 20, SpeedRunIGT.translate("speedrunigt.option.timer_position.show_time_only","Disable Timer Labels").append(" : ").append(drawer.isSimplyTimer() ? ScreenTexts.ON : ScreenTexts.OFF).asString());
        normalOptions.add(b1);
        buttons.add(b1);
        ButtonWidget b2=new ButtonWidget(5008,width / 2 - 80, height / 2 + 6, 160, 20, SpeedRunIGT.translate("speedrunigt.option.timer_position.lock_timer_position","Lock Timer Position").append(" : ").append(drawer.isLocked() ? ScreenTexts.ON : ScreenTexts.OFF).asString());
        normalOptions.add(b2);
        buttons.add(b2);
        ButtonWidget b3=new ButtonWidget(5009,width / 2 - 80, height / 2 + 28, 160, 20, SpeedRunIGT.translate("speedrunigt.option.timer_position.show_decimals","Timer Precision").append(" : ").append(new TranslatableText("speedrunigt.option.timer_position.show_decimals.context", drawer.getTimerDecimals().getNumber())).asString());
    ...
    public void initIGTButtons() {
        ...
        }, 5010, width / 2 - 147, height / 2 - 16, SpeedRunIGT.translate("speedrunigt.option.timer_position.igt.color_red", "IGT Red").append(" : ").append(String.valueOf(ColorMixer.getRed(drawer.getIGTColor()))).getString(), 0F, 255F, (float) (ColorMixer.getRed(drawer.getIGTColor()) / 255.0f),
        ...
        },5011,width / 2 - 147, height / 2 +6,  SpeedRunIGT.translate("speedrunigt.option.timer_position.igt.color_green", "IGT Green").append(" : ").append(String.valueOf(ColorMixer.getGreen(drawer.getIGTColor()))).getString(),0F, 255F,  (float)(ColorMixer.getGreen(drawer.getIGTColor()) / 255.0f) ,
        ...
        },5012,width / 2 - 147, height / 2 +28,SpeedRunIGT.translate("speedrunigt.option.timer_position.igt.color_blue", "IGT Blue").append(" : ").append(String.valueOf(ColorMixer.getBlue(drawer.getIGTColor()))).getString(),0F, 255F,  (float)(ColorMixer.getGreen(drawer.getIGTColor()) / 255.0f) ,
        ...
        ButtonWidget b4 =new SliderWidget(new PagedEntryListWidget.Listener() {
            ...
            @Override
            public void setFloatValue(int id, float value) {
                drawer.setIGTScale(Math.round((float) (value/100) * 3f * 20f)/20f);
                changed = true;
            }
        ...
        },5013,width / 2 + 6, height / 2 - 16, SpeedRunIGT.translate("speedrunigt.option.timer_position.igt.scale","IGT Timer Scale").append(" : ").append(((int) (drawer.getIGTScale() * 100)) + "%").getString(),0F, 100F,  (float)(ColorMixer.getGreen(drawer.getIGTColor()) / 255.0f) ,
    ...
    public void initRTAButtons() {
        ...
        }, 5010, width / 2 - 147, height / 2 - 16, SpeedRunIGT.translate("speedrunigt.option.timer_position.rta.color_red", "RTA Red").append(" : ").append(String.valueOf(ColorMixer.getRed(drawer.getRTAColor()))).getString(), 0F, 255F, (float) (ColorMixer.getRed(drawer.getRTAColor()) / 255.0f),
        ...
        },5011,width / 2 - 147, height / 2 +6,  SpeedRunIGT.translate("speedrunigt.option.timer_position.rta.color_green", "RTA Green").append(" : ").append(String.valueOf(ColorMixer.getGreen(drawer.getRTAColor()))).getString(),0F, 255F,  (float)(ColorMixer.getGreen(drawer.getRTAColor()) / 255.0f) ,
        ...
        },5012,width / 2 - 147, height / 2 +28,SpeedRunIGT.translate("speedrunigt.option.timer_position.rta.color_blue", "RTA Blue").append(" : ").append(String.valueOf(ColorMixer.getBlue(drawer.getRTAColor()))).getString(),0F, 255F,  (float)(ColorMixer.getGreen(drawer.getRTAColor()) / 255.0f) ,
        ...
        ButtonWidget b4 =new SliderWidget(new PagedEntryListWidget.Listener() {
            ...
            @Override
            public void setFloatValue(int id, float value) {
                drawer.setRTAScale(Math.round((float) (value/100) * 3f * 20f)/20f);
                changed = true;
            }
        ...
        },5013,width / 2 + 6, height / 2 - 16, SpeedRunIGT.translate("speedrunigt.option.timer_position.rta.scale","RTA Timer Scale").append(" : ").append(((int) (drawer.getRTAScale() * 100)) + "%").getString(),0F, 100F,  (float)(ColorMixer.getGreen(drawer.getRTAColor()) / 255.0f) ,
