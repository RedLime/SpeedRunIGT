...
public class SpeedRunOptions {
    ...
    public static ArrayList<Function<Screen, ClickableWidget>> buttons = new ArrayList<>();
    public static HashMap<Function<Screen, ClickableWidget>, List<Text>> tooltips = new HashMap<>();
    ...
    public static final OptionArgument<Identifier> TIMER_TEXT_FONT = new OptionArgument<>(new Identifier(SpeedRunIGT.MOD_ID, "timer_text_font"), MinecraftClient.DEFAULT_FONT_ID) {
        @Override
    ...
    public static final OptionArgument<Boolean> HIDE_TIMER_IN_OPTIONS = new OptionArgument<>(new Identifier(SpeedRunIGT.MOD_ID, "hide_timer_in_options"), true) {
        @Override
        public Boolean valueFromString(String string) {
            return Objects.equals(string, "true");
        }
    ...
    public static final OptionArgument<Float> TIMER_RTA_POSITION_Y = new OptionArgument<>(new Identifier(SpeedRunIGT.MOD_ID, "timer_rta_pos_y"), 0.035f) {
        @Override
        public Float valueFromString(String string) {
            return Float.parseFloat(string);
        }
    ...
    public static final OptionArgument<Float> TIMER_IGT_POSITION_X = new OptionArgument<>(new Identifier(SpeedRunIGT.MOD_ID, "timer_igt_pos_x"), 0.017f) {
        @Override
        public Float valueFromString(String string) {
            return Float.parseFloat(string);
        }
    ...
    public static final OptionArgument<Float> TIMER_IGT_POSITION_Y = new OptionArgument<>(new Identifier(SpeedRunIGT.MOD_ID, "timer_igt_pos_y"), 0.08f) {
        @Override
        public Float valueFromString(String string) {
            return Float.parseFloat(string);
        }
    ...
    public static final OptionArgument<Integer> RTA_BACKGROUND_PADDING = new OptionArgument<>(new Identifier(SpeedRunIGT.MOD_ID, "rta_bg_padding"), 3) {
        @Override
        public Integer valueFromString(String string) {
            return Integer.parseInt(string);
        }
    ...
    public static final OptionArgument<Integer> IGT_BACKGROUND_PADDING = new OptionArgument<>(new Identifier(SpeedRunIGT.MOD_ID, "igt_bg_padding"), 3) {
        @Override
        public Integer valueFromString(String string) {
            return Integer.parseInt(string);
        }
    ...
    public static final OptionArgument<Float> BACKGROUND_OPACITY = new OptionArgument<>(new Identifier(SpeedRunIGT.MOD_ID, "bgf_opacity"), 0f) {
        @Override
        public Float valueFromString(String string) {
            return Float.parseFloat(string);
        }
