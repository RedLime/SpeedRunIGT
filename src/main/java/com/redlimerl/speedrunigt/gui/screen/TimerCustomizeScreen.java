...
public class TimerCustomizeScreen extends Screen {
    ...
    private void openTab(int tab) {
        ...
        this.fontConfigButton.visible = tab == 3 && Objects.equals(this.drawer.getTimerFont().getNamespace(), SpeedRunIGT.MOD_ID);
    }
    ...
    protected void init() {
        ...
        this.addButton(new ButtonWidget(this.width / 2 - 89, this.height / 2 + 62, 58, 20, new TranslatableText("speedrunigt.option.hide"), (ButtonWidget button) -> {
            this.hide = !this.hide;
            for (AbstractButtonWidget normalOption : this.normalOptions) {
            ...
            button.setMessage(new TranslatableText("speedrunigt.option." + (!this.hide ? "hide" : "show")));
        }));
            ...
            if (!this.fontButton.active && this.client != null) {
                ...
                for (int i = 0; i < this.fontSelectButtons.size(); i++) {
                    if (c + i < this.availableFonts.size()) {
                        ...
                        this.drawCenteredText(matrices, this.textRenderer, text, this.width / 2 - 30,
    ...
    public void initNormal() {
        this.normalOptions.add(this.addButton(new ButtonWidget(this.width / 2 - 80, this.height / 2 - 16, 160, 20, new TranslatableText("speedrunigt.option.timer_position.show_time_only").append(" : ").append(this.drawer.isSimplyTimer() ? ScreenTexts.ON : ScreenTexts.OFF), (ButtonWidget button) -> {
        ...
        this.normalOptions.add(this.addButton(new ButtonWidget(this.width / 2 - 80, this.height / 2 + 6, 160, 20, new TranslatableText("speedrunigt.option.timer_position.lock_timer_position").append(" : ").append(this.drawer.isLocked() ? ScreenTexts.ON : ScreenTexts.OFF), (ButtonWidget button) -> {
        ...
        this.normalOptions.add(this.addButton(new ButtonWidget(this.width / 2 - 80, this.height / 2 + 28, 160, 20, new TranslatableText("speedrunigt.option.timer_position.show_decimals").append(" : ").append(new TranslatableText("speedrunigt.option.timer_position.show_decimals.context", this.drawer.getTimerDecimals().getNumber())), (ButtonWidget button) -> {
                ...
                }, (button, matrices, mouseX, mouseY) -> this.renderTooltip(matrices, new TranslatableText("speedrunigt.option.timer_position.show_decimals.description"), mouseX, mouseY)))
        );
    }

    public void initIGTButtons() {
        this.igtOptions.add(this.addButton(new SliderWidget(this.width / 2 - 127, this.height / 2 - 16, 120, 20, new TranslatableText("speedrunigt.option.timer_position.color_red", "IGT").append(" : ").append(String.valueOf(ColorMixer.getRed(this.drawer.getIGTColor()))), ColorMixer.getRed(this.drawer.getIGTColor()) / 255.0f) {
                    @Override
                    protected void updateMessage() {
                        this.setMessage(new TranslatableText("speedrunigt.option.timer_position.color_red", "IGT").append(" : ").append(String.valueOf(ColorMixer.getRed(TimerCustomizeScreen.this.drawer.getIGTColor()))));
                    }

                    @Override
                    protected void applyValue() {
                        int color = TimerCustomizeScreen.this.drawer.getIGTColor();
                        TimerCustomizeScreen.this.drawer.setIGTColor(
                                ColorMixer.getArgb(
        ...
        this.igtOptions.add(this.addButton(new SliderWidget(this.width / 2 - 127, this.height / 2 + 6, 120, 20, new TranslatableText("speedrunigt.option.timer_position.color_green", "IGT").append(" : ").append(String.valueOf(ColorMixer.getGreen(this.drawer.getIGTColor()))), ColorMixer.getGreen(this.drawer.getIGTColor()) / 255.0f) {
                    @Override
                    protected void updateMessage() {
                        this.setMessage(new TranslatableText("speedrunigt.option.timer_position.color_green", "IGT").append(" : ").append(String.valueOf(ColorMixer.getGreen(TimerCustomizeScreen.this.drawer.getIGTColor()))));
                    }
        ...
        this.igtOptions.add(this.addButton(new SliderWidget(this.width / 2 - 127, this.height / 2 + 28, 120, 20, new TranslatableText("speedrunigt.option.timer_position.color_blue", "IGT").append(" : ").append(String.valueOf(ColorMixer.getBlue(this.drawer.getIGTColor()))), ColorMixer.getBlue(this.drawer.getIGTColor()) / 255.0f) {
                    @Override
                    protected void updateMessage() {
                        this.setMessage(new TranslatableText("speedrunigt.option.timer_position.color_blue", "IGT").append(" : ").append(String.valueOf(ColorMixer.getBlue(TimerCustomizeScreen.this.drawer.getIGTColor()))));
                    }
        ...
        this.igtOptions.add(this.addButton(new SliderWidget(this.width / 2 + 6, this.height / 2 - 16, 120, 20, new TranslatableText("speedrunigt.option.timer_position.scale", "IGT").append(" : ").append((Math.round(this.drawer.getIGTScale() * 100)) + "%"), this.drawer.getIGTScale() / 3f) {
                    @Override
                    protected void updateMessage() {
                        this.setMessage(new TranslatableText("speedrunigt.option.timer_position.scale", "IGT").append(" : ").append((Math.round(TimerCustomizeScreen.this.drawer.getIGTScale() * 100)) + "%"));
                    }

                    @Override
                    protected void applyValue() {
                        TimerCustomizeScreen.this.drawer.setIGTScale(Math.round((float) this.value * 3f * 20f)/20f);
                        TimerCustomizeScreen.this.changed = true;
                    }
                })
        );

        this.igtOptions.add(this.addButton(new ButtonWidget(this.width / 2 + 6, this.height / 2 + 6, 120, 20, new TranslatableText("speedrunigt.option.timer_position.text_decorate", "IGT").append(" : ").append(new TranslatableText("speedrunigt.option.timer_position.text_decorate." + this.drawer.getIGTDecoration().name().toLowerCase(Locale.ROOT))), (ButtonWidget button) -> {
    ...
    public void initRTAButtons() {
        this.rtaOptions.add(this.addButton(new SliderWidget(this.width / 2 - 127, this.height / 2 - 16, 120, 20, new TranslatableText("speedrunigt.option.timer_position.color_red", "RTA").append(" : ").append(String.valueOf(ColorMixer.getRed(this.drawer.getRTAColor()))), ColorMixer.getRed(this.drawer.getRTAColor()) / 255.0f) {
                    @Override
                    protected void updateMessage() {
                        this.setMessage(new TranslatableText("speedrunigt.option.timer_position.color_red", "RTA").append(" : ").append(String.valueOf(ColorMixer.getRed(TimerCustomizeScreen.this.drawer.getRTAColor()))));
                    }

                    @Override
                    protected void applyValue() {
                        int color = TimerCustomizeScreen.this.drawer.getRTAColor();
                        TimerCustomizeScreen.this.drawer.setRTAColor(
                                ColorMixer.getArgb(
                                        ColorMixer.getAlpha(color),
                                        (int) (this.value * 255),
                                        ColorMixer.getGreen(color),
        ...
        this.rtaOptions.add(this.addButton(new SliderWidget(this.width / 2 - 127, this.height / 2 + 6, 120, 20, new TranslatableText("speedrunigt.option.timer_position.color_green", "RTA").append(" : ").append(String.valueOf(ColorMixer.getGreen(this.drawer.getRTAColor()))), ColorMixer.getGreen(this.drawer.getRTAColor()) / 255.0f) {
                    @Override
                    protected void updateMessage() {
                        this.setMessage(new TranslatableText("speedrunigt.option.timer_position.color_green", "RTA").append(" : ").append(String.valueOf(ColorMixer.getGreen(TimerCustomizeScreen.this.drawer.getRTAColor()))));
                    }
        ...
        this.rtaOptions.add(this.addButton(new SliderWidget(this.width / 2 - 127, this.height / 2 + 28, 120, 20, new TranslatableText("speedrunigt.option.timer_position.color_blue", "RTA").append(" : ").append(String.valueOf(ColorMixer.getBlue(this.drawer.getRTAColor()))), ColorMixer.getBlue(this.drawer.getRTAColor()) / 255.0f) {
                    @Override
                    protected void updateMessage() {
                        this.setMessage(new TranslatableText("speedrunigt.option.timer_position.color_blue", "RTA").append(" : ").append(String.valueOf(ColorMixer.getBlue(TimerCustomizeScreen.this.drawer.getRTAColor()))));
                    }
        ...
        this.rtaOptions.add(this.addButton(new SliderWidget(this.width / 2 + 6, this.height / 2 - 16, 120, 20, new TranslatableText("speedrunigt.option.timer_position.scale", "RTA").append(" : ").append((Math.round(this.drawer.getRTAScale() * 100)) + "%"), this.drawer.getRTAScale() / 3f) {
                    @Override
                    protected void updateMessage() {
                        this.setMessage(new TranslatableText("speedrunigt.option.timer_position.scale", "RTA").append(" : ").append((Math.round(TimerCustomizeScreen.this.drawer.getRTAScale() * 100)) + "%"));
                    }

                    @Override
                    protected void applyValue() {
                        TimerCustomizeScreen.this.drawer.setRTAScale(Math.round((float) this.value * 3f * 20f)/20f);
                        TimerCustomizeScreen.this.changed = true;
                    }
                })
        );

        this.rtaOptions.add(this.addButton(new ButtonWidget(this.width / 2 + 6, this.height / 2 + 6, 120, 20, new TranslatableText("speedrunigt.option.timer_position.text_decorate", "RTA").append(" : ").append(new TranslatableText("speedrunigt.option.timer_position.text_decorate." + this.drawer.getRTADecoration().name().toLowerCase(Locale.ROOT))), (ButtonWidget button) -> {
    ...
    public void initPositionButtons() {
        ...
        this.posOptions.add(this.addButton(new ButtonWidget(this.width / 2 - 80, this.height / 2 - 16, 160, 20, new TranslatableText("speedrunigt.option.timer_position.split_position").append(" : ").append(this.splitPosition ? ScreenTexts.ON : ScreenTexts.OFF), (button) -> {
    ...
    public void initFontButtons() {
        ...
        this.fontSelectButtons.add(this.addButton(new ButtonWidget(this.width / 2 + 35, this.height / 2 - 16, 50, 20, new TranslatableText("speedrunigt.option.select"), (ButtonWidget button) -> {
                    int c = (this.fontPage * 3);
        ...
        this.fontSelectButtons.add(this.addButton(new ButtonWidget(this.width / 2 + 35, this.height / 2 + 6, 50, 20, new TranslatableText("speedrunigt.option.select"), (ButtonWidget button) -> {
        ...
        this.fontSelectButtons.add(this.addButton(new ButtonWidget(this.width / 2 + 35, this.height / 2 + 28, 50, 20, new TranslatableText("speedrunigt.option.select"), (ButtonWidget button) -> {
        ...
        this.fontConfigButton = this.addButton(new ButtonWidget(this.width / 2 + 88, 0, 50, 20, new LiteralText("Config"), (ButtonWidget button) -> {
            if (this.client != null) this.client.openScreen(new FontConfigScreen(this, this.drawer.getTimerFont()));
        } ));
    ...
    public void initBackgroundButtons() {
        this.backgroundOptions.add(this.addButton(new SliderWidget(this.width / 2 - 80, this.height / 2 - 16, 160, 20, new TranslatableText("speedrunigt.option.timer_position.background_opacity").append(" : ").append((int) (this.drawer.getBGOpacity()*100) + "%"), this.drawer.getBGOpacity()) {
                    @Override
                    protected void updateMessage() {
                        this.setMessage(new TranslatableText("speedrunigt.option.timer_position.background_opacity").append(" : ").append((int) (TimerCustomizeScreen.this.drawer.getBGOpacity()*100) + "%"));
                    }

                    @Override
                    protected void applyValue() {
                        TimerCustomizeScreen.this.drawer.setBGOpacity((float) this.value);
                        TimerCustomizeScreen.this.changed = true;
                    }
                })
        );

        this.backgroundOptions.add(this.addButton(new SliderWidget(this.width / 2 - 80, this.height / 2 + 6, 160, 20, new TranslatableText("speedrunigt.option.timer_position.background_padding", "RTA").append(" : ").append(String.valueOf(this.drawer.getRTAPadding())), (this.drawer.getRTAPadding()-1) / 24f) {
                    @Override
                    protected void updateMessage() {
                        this.setMessage(new TranslatableText("speedrunigt.option.timer_position.background_padding", "RTA").append(" : ").append(String.valueOf(TimerCustomizeScreen.this.drawer.getRTAPadding())));
                    }

                    @Override
                    protected void applyValue() {
                        TimerCustomizeScreen.this.drawer.setRTAPadding((int) (this.value * 24) + 1);
                        TimerCustomizeScreen.this.changed = true;
                    }
                })
        );

        this.backgroundOptions.add(this.addButton(new SliderWidget(this.width / 2 - 80, this.height / 2 + 28, 160, 20, new TranslatableText("speedrunigt.option.timer_position.background_padding", "IGT").append(" : ").append(String.valueOf(this.drawer.getIGTPadding())), (this.drawer.getIGTPadding()-1) / 24f) {
                    @Override
                    protected void updateMessage() {
                        this.setMessage(new TranslatableText("speedrunigt.option.timer_position.background_padding", "IGT").append(" : ").append(String.valueOf(TimerCustomizeScreen.this.drawer.getIGTPadding())));
                    }

                    @Override
                    protected void applyValue() {
                        TimerCustomizeScreen.this.drawer.setIGTPadding((int) (this.value * 24) + 1);
                        TimerCustomizeScreen.this.changed = true;
                    }
                })
        );
