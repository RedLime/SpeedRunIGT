...
public class TheRunUploadKeyScreen extends Screen {
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        this.drawCenteredString(this.font, title.asFormattedString(), width / 2, 12, 16777215);
        ...
        if (statusCode == 1)
            this.drawCenteredString(this.font, new TranslatableText("speedrunigt.therun_gg.message.loading_upload_key_info").asFormattedString(), width / 2, height / 2 + 50, 16777215);

        if (statusCode == 2)
            this.drawCenteredString(this.font, new TranslatableText("speedrunigt.therun_gg.message.upload_key_is_valid").asFormattedString(), width / 2, height / 2 + 50, 16777215);

        if (statusCode == 3)
            this.drawCenteredString(this.font, new TranslatableText("speedrunigt.therun_gg.message.upload_key_is_invalid").asFormattedString(), width / 2, height / 2 + 50, 16777215);
