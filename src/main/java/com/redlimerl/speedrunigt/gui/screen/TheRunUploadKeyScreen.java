...
public class TheRunUploadKeyScreen extends Screen {
    ...
    protected void init() {
        super.init();
        assert client != null;
        client.field_19946.method_18191(true);
        ...
        method_13411(new ConsumerButtonWidget(width / 2 + 2, height / 2 + 24, 98, 20, ScreenTexts.CANCEL, (button) -> method_18608()));

        method_13411(new ConsumerButtonWidget(width / 2 - 100, height / 2 + 2, 200, 20, new TranslatableText("speedrunigt.therun_gg.get_upload_key").asFormattedString(), (button) -> Util.getOperatingSystem().method_20236("https://therun.gg/upload-key")));
        ...
        field_20307.add(this.uploadKeyBox);
        this.uploadKeyBox.setFocused(true);
    }

    @Override
    public void method_18608() {
        if (client != null) client.field_19946.method_18191(false);
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        this.uploadKeyBox.method_18385(mouseX, mouseY, delta);
