...
public class FontConfigScreen extends Screen {
    ...
    public void render(DrawContext drawContext, int mouseX, int mouseY, float delta) {
        ...
        drawContext.drawCenteredTextWithShadow(textRenderer, Text.literal("IGT: 01:23.456").setStyle(Style.EMPTY.withFont(fontIdentifier.getIdentifier())), width / 2, 30, 16777215);

        drawContext.drawCenteredTextWithShadow(textRenderer, "§l" + I18n.translate("speedrunigt.font.size") + ": " + ((int) newFontConfigure.size), width / 2, height / 2 - 55, 16777215);
        drawContext.drawCenteredTextWithShadow(textRenderer, "§l" + I18n.translate("speedrunigt.font.oversample") + ": " + newFontConfigure.oversample, width / 2, height / 2 - 5, 16777215);
        drawContext.drawCenteredTextWithShadow(textRenderer, I18n.translate("speedrunigt.font.oversample.description"), width / 2, height / 2 + 27, 16777215);
